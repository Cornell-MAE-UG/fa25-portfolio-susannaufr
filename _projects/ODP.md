...
<div style="text-align: left;">
  <img src="{{ '/assets/images/pA.png' | relative_url }}"  style="max-width:60%; height:auto;">
</div>
<div style="text-align: left;">
  <img src="{{ '/assets/images/pB.png' | relative_url }}"  style="max-width:60%; height:auto;">
</div>
**Assembly**  
...
<div style="text-align: left;">
  <img src="{{ '/assets/images/pC.png' | relative_url }}"  style="max-width:60%; height:auto;">
</div>
<div style="text-align: left;">
  <img src="{{ '/assets/images/pD.png' | relative_url }}"  style="max-width:60%; height:auto;">
</div>
<div style="text-align: left;">
  <img src="{{ '/assets/images/pE.png' | relative_url }}"  style="max-width:60%; height:auto;">
</div>
<div style="text-align: left;">
  <img src="{{ '/assets/images/pF.png' | relative_url }}"  style="max-width:60%; height:auto;">
</div>
